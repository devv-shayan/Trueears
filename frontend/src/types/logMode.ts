/**
 * Type definitions for Context-Aware Log Mode feature.
...
export const DEFAULT_TRIGGER_PHRASES: TriggerPhrase[] = [
  ...
  { id: 'default-log-that', phrase: 'Log that', enabled: true },
...
export const DEFAULT_LOG_MODE_CONFIG: LogModeConfig = {
  ...
  appMappings: [],
  defaultLogDirectory: '', // Will be initialized from backend on first load
  version: 1,
};
